...
2. Використовувати [`Option<T>`](https://doc.rust-lang.org/std/option/). Приклад:
...
1. Якщо помилка не страшна і не критична для програми, то нехай функція вертає [Result<T, E>](https://doc.rust-lang.org/std/result/).
