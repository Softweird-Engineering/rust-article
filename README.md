...
Ця стаття предназначена для людей, які взагалі не знають що таке Rust та як він працює, але знайомі хоча б із однією іншою мовою програмування. Також розуміють які є типи пам'яті у програми (я про стек та хіп) та як вона очищається у вашій мові програмування (руками, підрахунок силок, збірник сміття (garbage collector)).
