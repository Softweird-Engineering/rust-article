...
* **Інкапсуляція**. із ним все нормально. в нас є модифікатори доступу для модулів, структур, полів структур. Простий приклад:
